...
This appendix presents the modelling techniques applied to the simulator and discusses the processes used to analyse the datasets produced by the simulations it also shows the code required to implement the modelling in thw simulator.
